...
export default function Home() {
  ...
  return (
    <>
      ...
      <CustomAppBar 
        ...
        textColor={isDarkMode ? '#333333' : '#ffffff'}
        hoverColor="#f5f5f5"
      />
      ...
      <Container
        maxWidth="100vw"
        sx={{
          backgroundColor: isDarkMode ? '#EAE5F2' : '#151A0D',// Pastel background
          minHeight: '100vh',
      ...
      >
       ...
       <Typography  
        ...
        >
          ...
          <Typography variant="h5" sx={{ color: isDarkMode ? '#333333' : '#ffffff', mb: 4 }}>
          ...
          onClick={handleStarted}
             ...
             sx={{
               ...
               color: isDarkMode ? '#333333' : '#ffffff', // White text color
  ...
  <Grid container spacing={4} justifyContent="center">
    <Grid item xs={12} md={4}>
      ...
      >
        <Box>
        <Typography variant="h6" gutterBottom sx={{ fontWeight: 'bold', color: isDarkMode ? '#333333' : '#ffffff', fontSize: '1.5rem' }}>
        Effortless Flashcard Creation
        </Typography>
       
        <Box sx={{ textAlign: 'center', mb: 3 }}>
        <Typography variant="body1" gutterBottom sx={{ color: isDarkMode ? '#333333' : '#ffffff', mb: 2, fontSize: '1.2rem' }}>
    ...
    <Grid item xs={12} md={4}>
      ...
      <Box sx={{ textAlign: 'center' }}>
      <Typography  sx={{ color: isDarkMode ? '#333333' : '#ffffff', textAlign: 'center', textShadow: '2px 2px 4px rgba(128, 128, 128, 0.7)', fontSize: '3.45rem', fontWeight: '300', lineHeight: 1.2, letterSpacing: '0'}}>
           Subscription
      </Typography>
        ...
        <Grid item xs={12} sm={6} md={4}>
          <Box
            sx={{
              ...
              borderColor: "grey.300",
              borderRadius: 2,
              backgroundColor: isDarkMode ? '#EAE5F2' : '#151A0D', // Same as page background
          ...
          >
            <Box>
        <Typography variant="h4" gutterBottom sx={{ fontWeight: 'bold', color: isDarkMode ? '#333333' : '#ffffff', fontSize: '1.75rem', }}>
          Basic
        </Typography>
        <Typography variant="h5" gutterBottom sx={{ fontWeight: 'bold', color: isDarkMode ? '#333333' : '#ffffff', fontSize: '1.5rem' }}>
          $5 / month
        </Typography>
        <Typography variant="h6" gutterBottom sx={{ color: isDarkMode ? '#333333' : '#ffffff', mb: 2, fontSize: '1.2rem' }}>
          Access to basic flashcard features and limited storage.
        </Typography>
        <Box sx={{ textAlign: 'center', mb: 3 }}>
          <Typography variant="body1" sx={{ color: isDarkMode ? '#333333' : '#ffffff', mb: 2, fontSize: '1rem', fontWeight: 'bold' }}>
            <strong>Features:</strong>
          </Typography>
          <Typography variant="body1" sx={{ color: isDarkMode ? '#333333' : '#ffffff', mb: 1.5, fontSize: '1rem' }}>
          ...
          <Typography variant="body1" sx={{ color: isDarkMode ? '#333333' : '#ffffff', fontSize: '1rem' }}>
            ...
            <Button
                        ...
                        sx={{
                            ...
                            //mb: 1,
                            backgroundColor: '#ffb6c1', // Pastel pink background
                            color: isDarkMode ? '#333333' : '#ffffff', // Black text color
